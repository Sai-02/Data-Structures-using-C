...
askAgain:
    ...
    else if (userValue == 3)
    {
        ...
        else
        {
            ...
            printf("\nThe front value of queue is %d", queue[front]);
        }
    }
    else if (userValue == 4)
    {
        ...
        printf("\nThe rear value of queue is %d", queue[rear]);
    }
    else
    {
        goto end;
...
void ask()
{
    printf("\nPress 1 for enqueue     Press 2 for dequeue   Press 3 for front  Press 4 for rear   Press 0 to exit...\n  ");
}
